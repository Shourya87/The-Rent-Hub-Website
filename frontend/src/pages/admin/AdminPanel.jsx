...
export default function AdminPanel() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setUploadError(error instanceof Error ? error.message : "Unable to save property.");
    }
  };
                  ...
                  <tr key={property.id} className="border-b align-top">
                    ...
                    <td className="px-3 py-3">
                      <div className="flex gap-2">
                        ...
                        <button onClick={async () => { try { await deleteProperty(property.id); } catch (error) { setUploadError(error instanceof Error ? error.message : "Unable to delete property."); } }} className="rounded bg-red-600 px-3 py-1 text-white">Delete</button>
                      </div>
                    </td>
                  </tr>
                ))}
